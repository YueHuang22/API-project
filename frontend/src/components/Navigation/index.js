    ...
    if (sessionUser) {
        ...
        sessionLinks = (
            <>
                <span>
                    <span>
                        <LoginFormModal id="login-link" data-element-name="header-loginLink" data-event-label="Log in" class="ds-font-small-medium hover:no-underline text-gray7 hover:text-viridian" />
                    </span>
                    <span>
                        <NavLink to="/signup" id="register-link" data-element-name="header-registerLink" data-event-label="Sign up" class="ds-font-small-medium hover:no-underline text-gray7 hover:text-viridian">Sign up</NavLink>
                    </span>
                </span>
